...
<div id="sign">
    <div id="loginWrap">
        <div id="loginTit">
            ...
            <div id="tosignup">
                <a target="_blank" href="" style="color:#AAAAAA;margin-right:7px;">无法登陆？</a>|<a href="${pageContext.request.contextPath}/OldPage/regist.jsp" style="margin-left:10px;color:#d54e4e;">注册</a>
            </div>
        </div>
